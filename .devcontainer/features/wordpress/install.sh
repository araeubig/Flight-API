...
WP_INSTALL_LANGUAGES="${INSTALLLANGUAGES}"
WP_INSTALL_PLUGINS="${INSTALLPLUGINS}"
WP_ENVIRONMENT="${ENVIRONMENT}"
WP_THEMETEST="${THEMETEST}"

export WP_DOMAIN WP_MULTISITE WP_MULTISITE_TYPE WP_PERSIST_UPLOADS WP_INSTALL_LANGUAGES WP_INSTALL_PLUGINS WP_ENVIRONMENT WP_THEMETEST
# shellcheck disable=SC2016
envsubst '$WP_DOMAIN $WP_MULTISITE $WP_MULTISITE_TYPE $WP_PERSIST_UPLOADS $WP_INSTALL_LANGUAGES $WP_INSTALL_PLUGINS $WP_ENVIRONMENT $WP_THEMETEST' < conf-wordpress.tpl > /etc/conf.d/wordpress
